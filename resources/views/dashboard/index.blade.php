        ...
        <div class="col-xl-3">
            ...
            <div class="card card-custom bg-light-warning card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{ $detailPenjualans }}</span>
                    <span class="font-weight-bold text-muted font-size-sm">Jumlah Produk Terjual</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stat: Widget 28-->
